...
public class ExportTaxesController extends HttpServlet {
    ...
    public String doExport(HttpServletRequest request, HttpServletResponse response) throws IOException {

    	long currentTime = System.currentTimeMillis();

    	response.setContentType("application/vnd.ms-excel");
        response.setHeader("Content-Disposition",
                "attachment; filename=report-" + currentTime + ".xls");
        ...
        return "report-"+currentTime+".xls";
    }


    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {

    	System.out.println(doExport(request, response));
